...
Pod::Spec.new do |spec|
  ...
  # Or just: spec.author    = "ZT"
  # spec.authors            = { "ZT" => "3193152800@qq.com" }
  # spec.social_media_url   = "https://twitter.com/ZT"
  ...
  spec.source       = { :git => "https://github.com/ZT28TZ/uploadPod.git", :tag => "v0.0.1" }
